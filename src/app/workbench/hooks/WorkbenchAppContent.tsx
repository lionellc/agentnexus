...
import { useWorkbenchSkillsModuleBundle } from "./useWorkbenchSkillsModuleBundle";
...
import { useWorkbenchPromptAndSettingsViewBundle } from "./useWorkbenchPromptAndSettingsViewBundle";
...
export function WorkbenchAppContent() {
  ...
  const {
    APP_LANGUAGE_STORAGE_KEY, APP_THEME_STORAGE_KEY, AUTO_CHECK_APP_UPDATES, SKILL_OPEN_MODE_STORAGE_KEY, TRANSLATION_TARGET_LANGUAGE_STORAGE_KEY,
    activeModule, setActiveModule, promptViewMode, setPromptViewMode, skillDetailTab, setSkillDetailTab, skillsHubSortMode, setSkillsHubSortMode,
    setAgentPlatformOrder, activeWorkspaceAgentOrder, settingsCategory, setSettingsCategory, sidebarOpen, setSidebarOpen, mobileDetailOpen, setMobileDetailOpen,
    prompts: promptList, promptsLoading, promptVersions, fetchPrompts, selectPrompt, deletePrompt, createPrompt, updatePrompt, fetchPromptVersions, restorePromptVersion,
    promptSelectedIds, setPromptSelection, clearPromptSelection, batchFavorite, batchMove, batchDelete, promptBatchResult,
    skills: skillList, skillsLoading, selectedSkillId, fetchSkills, scanSkills, selectSkill, managerState, managerLoading, managerCalibrating, managerMode,
    managerExpandedSkillId, managerMatrixFilter, managerRowHints, usageAgentFilter, usageSourceFilter, usageEvidenceSourceFilter, usageStatsBySkillId,
    usageStatsLoading, usageStatsError, usageListSyncJob, usageDetailSyncJob, usageDetailCalls, usageDetailCallsTotal, usageDetailCallsLoading, usageDetailCallsError,
    getManagerOperationsRows, loadManagerState, managerBatchLink, managerBatchUnlink, setManagerMode, setManagerExpandedSkillId, setManagerMatrixFilter,
    clearManagerRowHint, setUsageFilters, refreshUsageStats, startListUsageSync, dismissListUsageSyncJob, startDetailUsageSync, loadUsageCalls, clearUsageDetail,
    agentAssets, agentTagsByAsset, agentVersionsByAsset, agentConnections, agentRulesError, selectedAssetId, setSelectedAssetId, clearAgentRulesError,
    loadAgentModuleData, loadAgentConnectionsStore: loadAgentConnections, loadAgentVersions, createAgentAsset, renameAgentAsset, deleteAgentAsset,
    publishAgentVersion, rollbackAgentRuleVersion, refreshAgentAsset, runAgentDistribution,
    activeWorkspaceId, settingsTargets, settingsConnections, dirty, settingsLoading, loadAllSettings, loadSettingsConnections, upsertTarget, deleteTarget,
    upsertConnection, toggleConnection, redetectConnection, restoreConnectionDefaults, setDirty,
    language, setLanguage, theme, setTheme, appVersion, setAppVersion, appUpdateStage, setAppUpdateStage, appUpdateVersion, setAppUpdateVersion,
    appUpdateError, setAppUpdateError, appUpdateProgress, setAppUpdateProgress, appUpdateRef, appUpdateAutoCheckedRef,
    skillOpenMenuRef, showSkillOpenModeInStatusBar, isZh, l, projectBootingMessage, markdownModeLabels, skillOpenModeOptions,
    createPromptOpen, setCreatePromptOpen, versionModalOpen, setVersionModalOpen, promptPage, setPromptPage, newPromptName, setNewPromptName,
    newPromptContent, setNewPromptContent, promptQuery, setPromptQuery, promptBrowseScope, setPromptBrowseScope, promptBrowseCategory, setPromptBrowseCategory,
    promptAllCategoryFilter, setPromptAllCategoryFilter, promptBatchJumpSuggestion, setPromptBatchJumpSuggestion, skillQuery, setSkillQuery,
    promptDetailView, setPromptDetailView, skillDetailView, setSkillDetailView, skillOpenMode, setSkillOpenMode, skillOpenMenuOpen, setSkillOpenMenuOpen,
    promptBatchCategory, setPromptBatchCategory, homePath, selectedSkillScanDirectories,
    detailName, setDetailName, detailCategory, setDetailCategory, detailTagsInput, setDetailTagsInput, detailContent, setDetailContent, detailFavorite, setDetailFavorite,
    modelLoading, setModelLoading, modelSaving, setModelSaving, localAgentProfiles, setLocalAgentProfiles, selectedModelProfileKey, setSelectedModelProfileKey,
    modelProfileName, setModelProfileName, modelExecutable, setModelExecutable, modelArgsTemplateText, setModelArgsTemplateText, newModelProfileName, setNewModelProfileName,
    translationPromptTemplate, setTranslationPromptTemplate, translationDefaultProfileKey, setTranslationDefaultProfileKey, modelTestSourceText, setModelTestSourceText,
    translationTargetLanguage, setTranslationTargetLanguage, modelScenarioSettingsOpen, setModelScenarioSettingsOpen, modelScenarioTestOpen, setModelScenarioTestOpen,
    modelTestOutputSheet, translationTargetLanguageOptions, compareLeftVersion, setCompareLeftVersion, compareRightVersion, setCompareRightVersion,
    promptVersionPreview, setPromptVersionPreview, promptVersionCompareMode, setPromptVersionCompareMode,
    selectedPrompt, selectedModelProfile, modelTestRunning, modelTestResult, selectedSkill, activeWorkspace, operationsScanDirectories, settingCategories,
  ...
  const {
    ...
    promptRunDialog,
    promptVersionDialog,
  } = useWorkbenchPromptAndSettingsViewBundle({
    l,
    isZh,
    constants: { SELECT_BASE_CLASS, PROMPTS_PAGE_SIZE },
    language,
    theme,
  ...
  const skillsModuleController = useWorkbenchSkillsModuleBundle({
    l,
    toast,
    activeWorkspaceId,
    projectBootingMessage,
