...
export function WorkbenchAppContent() {
  ...
  const {
    ...
    usageAgentFilter, usageSourceFilter, usageStatsLoading, usageStatsError, usageListSyncJob, usageDetailSyncJob,
    ...
    startDetailUsageSync, loadUsageCalls, clearUsageDetail,
    ...
    loadSettingsConnections, upsertTarget, deleteTarget, upsertConnection, deleteConnection, setDirty,
