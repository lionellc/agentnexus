...
use super::{
    connection_defaults::{
        candidate_root_dirs, detect_candidate_root, infer_detection_status, is_manual_overridden,
        normalize_detection_status, normalize_path_source, validate_enabled_search_dirs,
        DETECTION_DETECTED, DETECTION_UNDETECTED, SOURCE_INFERRED, SOURCE_MANUAL,
    },
    normalize::{
